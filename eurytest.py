...
pc = pbecalcs.PBESTRUCT('eurybates','lucy',kern=["latest_kernels/mk/lcy.eury.27219.v03.tm"])
...
pc = pbecalcs.PBESTRUCT('queta','lucy',kern=["latest_kernels/mk/lcy.eury.27219.v03.tm"])
pprint.pprint(dict(pbecalcs=vars(pc)
                  ,pbecalcs_kinetx=vars(pc.kinetx)
                  ,pbecalcs_pbeArr00=vars(pc.pbeArr[0,0])
                  ,yw_scanVinfUptrack=vars(pc.pbeArr[0,0].scanVinfUptrack)
